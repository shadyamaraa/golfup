const T = {
  ...
  en: {
    ...
    statGames: 'Games', statFollowing: 'Following', statFollowers: 'Followers', statsTab: 'Statistics', statTotalGames: 'Total games', statThisMonth: 'This month', statActive30: 'Active (30 days)', statTopLocations: 'Top locations', statPlayerStats: 'Player statistics', statCreated: 'Created', statJoined: 'Joined', statDeletedNote: 'Deleted games',
  ...
  kr: {
    ...
    statGames: '게임', statFollowing: '팔로잉', statFollowers: '팔로워', statsTab: '통계', statTotalGames: '전체 경기', statThisMonth: '이번 달', statActive30: '활성 (30일)', statTopLocations: '인기 장소', statPlayerStats: '플레이어 통계', statCreated: '생성', statJoined: '참여', statDeletedNote: '삭제된 경기',
