const T = {
  mn: {
    ...
    appearance: 'Харагдац', themeLight: 'Цайвар', themeDark: 'Бараан', language: 'Хэл',
  ...
  en: {
    ...
    appearance: 'Appearance', themeLight: 'Light', themeDark: 'Dark', language: 'Language',
  ...
  kr: {
    ...
    appearance: '테마', themeLight: '밝게', themeDark: '어둡게', language: '언어',
