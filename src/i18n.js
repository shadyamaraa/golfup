const T = {
  mn: {
    ...
    joinPayTitle: 'Төлбөрийн мэдээлэл', joinPayPerPlayer: 'Нэг хүний төлбөр (тооцоолол)',
  ...
  en: {
    ...
    joinPayTitle: 'Payment details', joinPayPerPlayer: 'Estimated price per player',
  ...
  kr: {
    ...
    joinPayTitle: '결제 정보', joinPayPerPlayer: '1인당 예상 요금',
