...
export const ICON_PATHS = {
  ...
  // Weather set (WMO code groups → src/weather.js wmoInfo)
  'wx-sun': '<circle cx="12" cy="12" r="4.2"/><path d="M12 3.2v2M12 18.8v2M4.6 12h-2M21.4 12h-2M6.5 6.5 5 5M19 19l-1.5-1.5M17.5 6.5 19 5M5 19l1.5-1.5"/>',
  'wx-cloud-sun': '<circle cx="8.2" cy="8.2" r="3"/><path d="M8.2 3.5V2.3M3.5 8.2H2.3M4.9 4.9l-.9-.9M12.3 4.5l.9-.9"/><path d="M8 15.4a4.4 4.4 0 0 1 8.6-1.3 3.4 3.4 0 0 1-.6 6.8H10A3.2 3.2 0 0 1 8 15.4z"/>',
  'wx-cloud': '<path d="M6.3 12.4a4.8 4.8 0 0 1 9.4-1.4 3.7 3.7 0 0 1-.7 7.3H8.4a3.5 3.5 0 0 1-2.1-5.9z"/>',
  'wx-rain': '<path d="M6.3 10.9a4.8 4.8 0 0 1 9.4-1.4 3.7 3.7 0 0 1-.7 7.3H8.4a3.5 3.5 0 0 1-2.1-5.9z"/><path d="m8.7 20.7.8-1.9M12.3 20.7l.8-1.9M15.9 20.7l.8-1.9"/>',
  'wx-snow': '<path d="M6.3 10.9a4.8 4.8 0 0 1 9.4-1.4 3.7 3.7 0 0 1-.7 7.3H8.4a3.5 3.5 0 0 1-2.1-5.9z"/><circle cx="9.2" cy="19.7" r=".65" fill="currentColor" stroke="none"/><circle cx="12.7" cy="20.6" r=".65" fill="currentColor" stroke="none"/><circle cx="16.2" cy="19.7" r=".65" fill="currentColor" stroke="none"/>',
  'wx-fog': '<path d="M6.8 8.6a4.4 4.4 0 0 1 8.6-1.2 3.4 3.4 0 0 1 2.3 4.4"/><path d="M4.5 14.5h15M6.5 17.8h11"/>',
  'wx-thunder': '<path d="M6.3 10.4a4.8 4.8 0 0 1 9.4-1.4 3.7 3.7 0 0 1-.7 7.3h-1.4"/><path d="m12.6 12.3-2.3 4h2.5l-1.5 4"/>',
  'wx-wind': '<path d="M3.5 8.5h9.8a2.6 2.6 0 1 0-2.4-3.6M3.5 12.5h13.9a2.7 2.7 0 1 1-2.5 3.7M3.5 16.5h6.8"/>',
  'wx-drop': '<path d="M12 3.5c3.2 3.9 5.2 6.8 5.2 9.6a5.2 5.2 0 0 1-10.4 0c0-2.8 2-5.7 5.2-9.6z"/>',
};
